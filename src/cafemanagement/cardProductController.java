...
public class cardProductController implements Initializable {
    ...
    public void addBtn() {
        ...
        try {
            ...
            if (check != "Available" || qty == 0) {
                alert = new Alert(AlertType.ERROR);
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Product not Available OR quantity chosen is 0 !");
                alert.showAndWait();
            } else {
                ...
                if (checkStck < qty) {
                    ...
                    alert.setTitle("Error Message");
                    alert.setHeaderText(null);
                    alert.setContentText("Out of Stock ,please select less Quantity");
                    alert.showAndWait();
                } else {
